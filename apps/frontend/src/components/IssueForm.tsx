...
export const IssueForm: React.FC<IssueFormProps> = ({ issueId }) => {
    ...
    return (
        <div className="max-w-2xl mx-auto space-y-4 sm:space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-6 bg-white/5 backdrop-blur-md p-4 sm:p-6 rounded-lg border border-white/10 shadow-sm text-slate-100">
                <div className="space-y-2">
                    <label className="text-sm font-medium text-slate-200">Title</label>
                    <input
                        type="text"
                        required
                        className="w-full rounded-md border border-white/20 p-2 bg-white/10 text-slate-100 focus:ring-2 focus:ring-cyan-500 focus:outline-none placeholder-slate-400"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-2">
                        ...
                        <select
                            className="w-full rounded-md border border-white/20 p-2 bg-white/10 text-slate-100 focus:ring-2 focus:ring-cyan-500 focus:outline-none"
                    ...
                    <div className="space-y-2">
                        ...
                        <select
                            disabled={!canAssign}
                            className="w-full rounded-md border border-white/20 p-2 bg-white/10 text-slate-100 focus:ring-2 focus:ring-cyan-500 focus:outline-none disabled:bg-white/5 disabled:text-slate-500"
